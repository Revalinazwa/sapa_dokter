                            ...
                            <table class="filter-container doctor-header" style="border: none;width:95%" border="0" >
                                <tr>
                                    <td >
                                        ...
                                        <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:30%">Lihat Daftar Konsultasi</button></a>
                                        <br>
                                        <br>
                                    </td>
                                </tr>
                    ...
                    <td colspan="4">
                        <table border="0" width="100%">
                            <tr>
                                ...
                                <td>
                                    <p id="anim" style="font-size: 20px;font-weight:600;padding-left: 40px;">Daftar Jadwal Sesi Pemeriksaan</p>
                                    <center>
