        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;" >
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Pertemuan Saya (<?php echo $list110->num_rows; ?>)</p>
                </td>
            </tr>
                                ...
                                <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            ...
                                            <option value="" disabled selected hidden>Pilih daftar dokter</option><br/>';
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="time" class="form-label">Jaswal Waktu: </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                        ...
                        <div class="popup">
                            <center>
                                ...
                                <div class="content">
                                    ...
                                    Nomor Pertemuan &nbsp; : <b>'.substr($apponum,0,40).'</b><br><br>
                                </div>
                                <div style="display: flex;justify-content: center;">
