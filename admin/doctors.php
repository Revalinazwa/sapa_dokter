    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        ...
                        <div class="content">
                            ingin menghapus data ini<br>('.substr($nameget,0,40).').
                        </div>
                        <div style="display: flex;justify-content: center;">
            ...
            ';
                ...
                $error_1=$_GET["error"];
                $errorlist= array(
                    '1'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Alamat email tersebut sudah memiliki akun</label>',
                    '2'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Konfirmasi kata sandi gagal! Silahkan coba lagi</label>',
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nic" class="input-text" placeholder="Nomor Induk Kependudukan" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Pilih Spesialisasi: (Current'.$spcil_name.')</label>
