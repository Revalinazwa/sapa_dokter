                ...
                <tr>
                    ...
                    <td>
                        <form action="" method="post" class="header-search">
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Masukkan nama atau email dokter" list="doctors">&nbsp;&nbsp;
                            <?php
                                ...
                                <tbody>
                                    <?php                                
                                        ...
                                        if($result->num_rows==0){
                                            ...
                                            <br>
                                            <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Mohon maaf, kami tidak menumukan apa yang Anda cari ;(</p>
                                            <a class="non-style-link" href="doctors.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Tampilkan semua jadwal &nbsp;</font></button>
                                            </a>
                                            </center>
                                            <br><br><br><br>
                                            </td>
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                            <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                <tr>
                                    <td>
                                        <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Detail Profil</p><br><br>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <label for="spec" class="form-label">Bidang Spesialis: </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                ...
                <div class="popup">
                    <center>
                        <h2>Pindah ke Jadwal Dokter?</h2>
                            <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
                            Anda akan melihat seluruh jadwal oleh <br>('.substr($name,0,40).').
                        </div>
