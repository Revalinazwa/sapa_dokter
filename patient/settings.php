                                            ...
                                            <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/icons/doctors-hover.svg');"></div>
                                                <div>
                                                    ...
                                                    <div class="h3-dashboard" style="font-size: 15px;">
                                                        Edit profil akun dan ubah kata sandi
                                                    </div>
                                                </div>            
                                            </div>
                                        </a>
                                        ...
                                        <a href="?action=drop&id=<?php echo $userid.'&name='.$username ?>" class="non-style-link">
                                            <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="h3-dashboard"  style="font-size: 15px;">
                                                        Akun Anda akun terhapus secara permanen
                                                    </div>
                                                </div>            
                                            </div>
                                        </a>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            Akun Anda akan terhapus secara permanen<br>('.substr($nameget,0,40).').
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Detail Akun</p><br><br>
                                </td>
                            </tr>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Akun Pengguna</p>
                                        ID Pengguna : '.$id.'<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="name" class="input-text" placeholder="Nama" value="'.$name.'" required><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nic" class="input-text" placeholder="Nomor Induk Kependudukan" value="'.$nic.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="tel" name="Tele" class="input-text" placeholder="contoh: 0821xxxxxx" value="'.$tele.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="password" class="input-text" placeholder="Masukkan kata sandi" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Masukkan ulang kata sandi" required><br>
                                        </td>
                                    </tr>
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <center>
                        <br><br><br><br>
                            <h2>Perubahan berhasil!</h2>
                            <a class="close" href="settings.php">&times;</a>
                            <div class="content">
                                Jika Anda juga mengubah email Anda, silakan keluar dan masuk lagi dengan email baru Anda
